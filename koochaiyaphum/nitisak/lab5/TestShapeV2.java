...
public  class TestShapeV2 {
    public static void main(String[] args) {
        ...
        System.out.println("First rectangle Are = " + r1.getArea() + " Perimeter = " + r1.getPerimeter());
        Rectangle r2 = new Rectangle(2.0, 3.0,"Pink",true);
        System.out.println(r2);
        System.out.println("Second rectangle Are = " + r2.getArea() + " Perimeter = " + r2.getPerimeter());
